			...
			<div id="container">
				<ion-toolbar>
					<ion-buttons slot="start">
						<ion-input label="Title:" readonly v-model="title"></ion-input>
					</ion-buttons>
				...
				<ion-toolbar>
					<ion-buttons slot="start">
						<ion-input label="Artist:" readonly v-model="artist"></ion-input>
					</ion-buttons>
					<ion-buttons slot="end">
						<ion-item>
							<ion-select v-model="category" disabled label="Category" placeholder="">
...
onIonViewDidEnter(async () => {
	...
	element[0].innerHTML = song.value.chords;
});
